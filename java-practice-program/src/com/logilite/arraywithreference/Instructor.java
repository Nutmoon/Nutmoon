...
public class Instructor {
	...
	public static void main(String[] args) {
		Book book1 = new Book("C Language");
		Book book2 = new Book("C++ Language");
		Book book3 = new Book("java Language");
		...
		System.out.println("old book title: " + instructor.updateBook(1, "Advance Java").getTitle());

		Book book4 = new Book("");
		System.out.println("update book title: " + instructor.updateBook(1, book4).getTitle());
	}
}
