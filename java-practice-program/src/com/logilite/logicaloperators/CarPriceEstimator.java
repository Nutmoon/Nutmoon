package com.logilite.logicaloperators;
...
public class CarPriceEstimator {
	...
	public double getSalePrice(String makeAndModel, int yearManufactured, double milesDriven, int airBagsCount,
		...
		if (additionalMiles > 1000 && additionalMiles <= 30000) {
			salePrice -= 500;
		}
	...
	private double getPrice(String makeAndModel, int yearManufactured) {
		if (makeAndModel.equalsIgnoreCase("B M W")) {
			return 20000.0;
		} else if (makeAndModel.equalsIgnoreCase("Mercedes")) {
			return 25000.0;
		} else if (makeAndModel.equalsIgnoreCase("Hyundai")) {
			return 30000.0;
		}
		return 20000.0;
	}
	...
	public static void main(String[] args) {
		...
		double salesPrice = carPriceEstimator.getSalePrice("Hyundai", 2018, 60000.0, 2, true, false, true, false,
				false, true);
	}
}
